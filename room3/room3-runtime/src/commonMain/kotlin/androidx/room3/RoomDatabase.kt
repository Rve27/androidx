...
public expect abstract class RoomDatabase() {
     ...
     */
    @RestrictTo(RestrictTo.Scope.LIBRARY_GROUP_PREFIX) // used in generated code
    public fun <T : Any> getDaoReturnTypeConverter(klass: KClass<T>): T
    ...
    /**
     * Returns a Map of String -> List&lt;KClass&gt; where each entry has the `key` as the DAO name
     * and `value` as the list of DAO return type converter classes that are necessary for the
     * database to function.
     *
     * An implementation of this function is generated by the Room processor. Note that this method
     * is called when the [RoomDatabase] is initialized.
     *
     * @return A map that will include all required DAO return type converters for this database.
     */
    @RestrictTo(RestrictTo.Scope.LIBRARY_GROUP_PREFIX) // used in generated code
    protected open fun getRequiredDaoReturnTypeConverterClasses(): Map<KClass<*>, List<KClass<*>>>
    /**
     ...
     */
    public abstract suspend fun clearAllTables()
    ...
    public class Builder<T : RoomDatabase> {
         ...
         */
        @JvmOverloads
        public fun fallbackToDestructiveMigration(dropAllTables: Boolean = true): Builder<T>
         ...
         */
        @JvmOverloads
        public fun fallbackToDestructiveMigrationOnDowngrade(
            dropAllTables: Boolean = true
        ): Builder<T>
         ...
         * @return This builder instance.
         */
        public fun addDaoReturnTypeConverter(daoReturnTypeConverter: Any): Builder<T>
         ...
         */
        public fun setSingleConnectionPool(): Builder<T>
